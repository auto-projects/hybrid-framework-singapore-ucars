...
public class ReportNGListener extends BaseTest implements ITestListener {
	...
	public String captureScreenshot(WebDriver driver, String screenshotName) {
		try {
			...
			String screenPath = GlobalConstants.REPORTNG_SCREENSHOT + screenshotName + "_" + formater.format(calendar.getTime()) + ".png";FileUtils.copyFile(source, new File(screenPath));
			return screenPath;
		} catch (IOException e) {
